...
module.exports = postcss.plugin('context-queries', function (opts) {
    ...
    var logContext = function (object, feature, value) {
    	...
    	// Check wether value is a number or not...
    	//object[feature].push(isNaN(+value) ? value : +value);
	...
	var layoutSelector = function (layouts) {
	    ...
	    var attrWidth = "component-width" + opts.attrJoiner;
	    var attrHeight = "component-height" + opts.attrJoiner;
